...
public class Conversation{
    ...
    private String cus_info_id;//客户信息id
    ...
    private String pcode;//来电原因父级code
    ...
    private String cus_shop_time;//商家注册时间
    ...
    private String sheetStatus;//工单状态

    private String isEdit;//是否可以编辑

    private String isOrder;//是否是订单的会话
