 ...
 */
@FeignClient(value="ackservice")//name:表示调用的是那个服务，后面的url表示服务地址
public interface AckServiceFeignService {
     ...
     * @return
     */
    @RequestMapping(value = "/tree/delete")
    ...
    JSONObject findInformationById(@RequestParam("id")int id);
     ...
     * @return
     */
    @RequestMapping(value = "/info/findInformationByTrees",method = RequestMethod.GET)
    JSONArray findInformationByTrees(@RequestParam("treeId")int treeId,@RequestParam("pjt_code") String pjt_code);
     ...
     * @return
     */
    @RequestMapping(value = "/info/findInformationByContent",method = RequestMethod.GET)
    JSONArray findInformationByContent(@RequestParam("content")String content,@RequestParam("pjt_code")String pjt_code);
     ...
     * @return
     */
    @RequestMapping(value = "/tree/prmentTrees",method = RequestMethod.GET)
    JSONArray prmentTrees(@RequestParam("treeId")int treeId,@RequestParam("pjt_code") String pjt_code);
