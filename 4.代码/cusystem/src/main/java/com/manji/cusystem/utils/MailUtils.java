...
public class MailUtils {
    ...
    public void main(String[] args){
        ...
        String str = "{\"end_time\":null,\"keyword\":null,\"pageNumber\":1,\"pageSize\":15,\"start_time\":null,\"type\":\"1\"}";

        JSONObject obj = new JSONObject();
        Map<String,Object> map = obj.parseObject(str,new TypeReference<Map<String, Object>>(){});
