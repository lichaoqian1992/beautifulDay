...
public class ExcelUtils {
    ...
    private static final  String url = "E://";//本地上传地址
	 ...
	 * @return
	 */
	public static String excel(ExcelVo param, String[] title, String excelName, String[][] content){
    ...
    public static void main(String[] args){
        ...
        vo.setStartTime("2017-09-04");
        vo.setEndTime("2017-09-10");
        ...
        String path = excel(vo,title,"测试",content);
