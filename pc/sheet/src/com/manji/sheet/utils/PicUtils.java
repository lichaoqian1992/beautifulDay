...
public class PicUtils {
	...
	//private static String TEST_URL="http://service.manji.com/AppService.asmx/UploadFile";//开发
	private static String TEST_URL="http://servicetest.manji.com/AppService.asmx/UploadFile";//测试
