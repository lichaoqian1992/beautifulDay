					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderCommentTem"><i class="icon-pencil"></i>新增订单评论信息模板</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var no =Number(i+1);
					var id=item.id;
					var order_tem_type=item.order_tem_type;
					var order_tem_content=item.order_tem_content;
					 
					 var rowhtml ="<tr>"+
					 "<td>"+no+"</td>"+
					 "<td>"+order_tem_type+"</td>"+
					 "<td>"+order_tem_content+"</td>"+
					 "<td>"+"<a href='readOrderCommentTem?id="+id+"'>修改</a>&nbsp;<a href='delOrderCommentTem?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
