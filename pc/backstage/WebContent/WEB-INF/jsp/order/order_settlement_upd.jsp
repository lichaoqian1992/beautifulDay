...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改订单结算内容信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var ordersettlementinfo=${ordersettlementinfo };
		console.log(ordersettlementinfo);
		var id=ordersettlementinfo.id;
		var order_id=ordersettlementinfo.order_id;
		var order_no=ordersettlementinfo.order_no;
		var order_type=ordersettlementinfo.order_type;
		var shop_user_id=ordersettlementinfo.shop_user_id;
		var shop_user_role_type=ordersettlementinfo.shop_user_role_type;
		var shop_user_role_value=ordersettlementinfo.shop_user_role_value;
		var settlement_money=ordersettlementinfo.settlement_money;
		var percentage_money=ordersettlementinfo.percentage_money;
		var real_money=ordersettlementinfo.real_money;
		var add_time=ordersettlementinfo.add_time;
		var remark=ordersettlementinfo.remark;
		...
		$("#percentage_money").val(percentage_money);
