...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改订单详细商品类信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var ordergoodinfo=${ordergoodinfo };
		
		var id=ordergoodinfo.id;
		var order_id=ordergoodinfo.order_id;
		var express_id=ordergoodinfo.express_id;
		var express_no=ordergoodinfo.express_no;
		var express_status=ordergoodinfo.express_status;
		var express_time=ordergoodinfo.express_time;
		var accept_name=ordergoodinfo.accept_name;
		var post_code=ordergoodinfo.post_code;
		var telephone=ordergoodinfo.telephone;
		var mobile=ordergoodinfo.mobile;
		var email=ordergoodinfo.email;
		var area=ordergoodinfo.area;
		var address=ordergoodinfo.address;
		var is_receipt=ordergoodinfo.is_receipt;
		var is_deliver=ordergoodinfo.is_deliver;
