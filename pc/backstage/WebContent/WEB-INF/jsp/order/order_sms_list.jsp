					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderSms"><i class="icon-pencil"></i>新增订单详细短信类信息</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var back_order_id=item.back_order_id;
					 ...
					 "<td>"+no+"</td>"+
					 "<td>"+order_id+"</td>"+
					 "<td>"+business_sms_id+"</td>"+
					 "<td>"+title+"</td>"+
					 "<td>"+price+"</td>"+
					 "<td>"+quantity+"</td>"+
					 "<td>"+back_order_id+"</td>"+
					 "<td>"+"<a href='readOrderSms?id="+id+"'>修改</a>&nbsp<a href='delOrderSms?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
