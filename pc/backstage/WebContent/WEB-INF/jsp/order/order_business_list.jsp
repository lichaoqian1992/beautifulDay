					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderBusiness"><i class="icon-pencil"></i>新增订单详细业务类信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var business_user_id=item.business_user_id;
					...
					var back_order_id=item.back_order_id;
					 ...
					 "<td>"+no+"</td>"+
					 "<td>"+order_id+"</td>"+
					 "<td>"+business_user_id+"</td>"+
					 "<td>"+title+"</td>"+
					 "<td>"+price+"</td>"+
					 "<td>"+quantity+"</td>"+
					 "<td>"+back_order_id+"</td>"+
					 "<td>"+"<a href='readOrderBusiness?id="+id+"'>修改</a><a href='delOrderBusiness?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
