...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">转账信息</span>
								</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">对象用户ID：</label>
													<div class="controls">
														<input id="touserid" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												
												<div class="control-group">
													<label class="control-label">对象角色类型：</label>
													<div class="controls">
														<select id="touserroletype" class="small m-wrap" >
															<option value="Buyer">买家</option>
															<option value="Shop">商家</option>
															<option value="Agent">代理商</option>
															<option value="Manager">管理员</option>
												...
												<div class="control-group">
													<label class="control-label">对象角色值：</label>
													<div class="controls">
														<input id="touserrolevalue" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="transactionno" type="text" 	class="m-wrap large" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												...
												<div class="control-group">
													<label class="control-label">转账标记：</label>
													<div class="controls">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selTransaction">返回</a>
	...
	function infoset(){
		...
		var id=transactioninfo.id;
		var user_id =transactioninfo.user_id;
		var role_type =transactioninfo.user_role_type;
		var role_value =transactioninfo.user_role_value;
		var touser_id =transactioninfo.touser_id;
		var touser_role_type =transactioninfo.touser_role_type;
		var touser_role_value =transactioninfo.touser_role_value;
		var transaction_no =transactioninfo.transaction_no;
		var amount =transactioninfo.amount;
		var status =transactioninfo.status;
		var add_time =transactioninfo.add_time;
		var complete_time =transactioninfo.complete_time;
		var remark =transactioninfo.remark;
		var is_del =transactioninfo.is_del;
		...
		$("#touserid").val(touser_id);
		$("#touserroletype").val(touser_role_type);
		$("#touserrolevalue").val(touser_role_value);
	...
	$("#subbutton").on("click",function(){
		...
		data : {
			...
			touser_id:$("#touserid").val(),
			touser_role_type:$("#touserroletype").val(),
			touser_role_value:$("#touserrolevalue").val(),
