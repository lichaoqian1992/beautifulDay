					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insBuyerInfo"><i class="icon-pencil"></i>新增买家信息记录</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var update_time=item.update_time;
					 ...
					 "<td>"+areas+"</td>"+
					 "<td>"+update_time+"</td>"+
					 "<td>"+"<a href='readBuyerInfo?id="+id+"'>修改</a>&nbsp;<a href='delBuyerInfo?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
