		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
										商家列表<!-- <small>代理商列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="*">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">商家账户管理</a><i class="icon-angle-right"></i></li>
							<li><a href="#">商家列表</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a href="insShopGroup" class="btn blue"><i class="icon-pencil"></i>新增</a>
...
$(document).ready(
			...
			function() {
				...
				$.each(data,function(i, branditem) {
									...
									is_upgrade == 0 ? is_upgrade = "否" : is_upgrade = "是";
									is_lock == 0 ? is_lock = "否" : is_lock = "是";
