...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">商家组别管理</a><i class="icon-angle-right"></i></li>
							<li><a href="#">修改商家组别信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">商家组别信息</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="grade" type="text" 	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="is_default" class="medium m-wrap" >
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="is_upgrade" class="medium m-wrap" >
															<option value="0">否</option>
															<option value="1">是</option>
														</select>
													</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="is_lock" class="medium m-wrap" >
															<option value="0">否</option>
															<option value="1">是</option>
														</select>
													</div>
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selShopGroup">返回</a>
	...
	<script>
		$(document).ready(function() {
			...
			function infoset(){
				var groupinfo =${shopinfo};
				var id=groupinfo.id
				$("#hiddenid").val(id);
				var title =groupinfo.title;
				$("#title").val(title);
				var grade =groupinfo.grade;
				$("#grade").val(grade);
				var upgrade_exp =groupinfo.upgrade_exp;
				$("#upgrade_exp").val(upgrade_exp);
				var amount =groupinfo.amount;
				$("#amount").val(amount);
				var point =groupinfo.point;
				$("#point").val(point);
				var discount =groupinfo.discount;
				$("#discount").val(discount);
				var is_default =groupinfo.is_default;
				$("#is_default").val(is_default);
				var is_upgrade =groupinfo.is_upgrade;
				$("#is_upgrade").val(is_upgrade);
				var is_lock =groupinfo.is_lock;
				$("#is_lock").val(is_lock);
