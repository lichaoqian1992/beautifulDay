...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOtherInfo"><i class="icon-pencil"></i>新增上传资质信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class="row_fluid ">
									<ul>
										<li>商家ID：<input type="text" id="shop_id"
											class="small m-wrap"></li>
										<li>商家用户ID：<input type="text" id="shop_user_id"
											class="small m-wrap"></li>
										<li>标题：<input type="text" id="title"
											class="small m-wrap"></li>
										<li style="width: 80px"><a
											class="btn btn-primary search_sub" style="margin-top: -9px;"
	...
	if($("#shop_user_id").val()!=""){
		ajaxdatas+="&shop_user_id="+$("#shop_user_id").val();
	}
	if($("#shop_id").val()!=""){
				...
				$.each(data,function(i,item){
					...
					is_del == 0 ? is_del = "正常" : is_del = "删除";
					 ...
					 var rowhtml ="<tr>"+
						...
						"<td>"+"<a href=readOtherInfo?id="+id+">修改</a>&nbsp;<a href=delOtherInfo?id="+id+">删除</a>"+"</td>"+
						"</tr>";
