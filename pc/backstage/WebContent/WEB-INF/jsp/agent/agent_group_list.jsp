		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
										代理商组别列表<!-- <small>代理商列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="*">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">代理商组别管理</a><i class="icon-angle-right"></i></li>
							<li><a href="selAgentGroup">代理商组别列表</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a href="insAgentGroup" class="btn blue"><i class="icon-pencil"></i>新增</a>
				...
				$.each(data,function(i, branditem) {
									...
									$("#tablebody").append(
													"<tr><td>"
															...
															+ is_lockstr
															+ "</td><td>"
															+ "<a href='chgAgentGroup?id="+id+"'>修改</a><a href='delAgentGroup?id="+id+"'>删除</a>"+"</td>"+
															+ "</td></tr>");
			...
			success : function(data) {
				...
				$.each(listdate,function(i,item){
					...
					var row ="<tr>"+
					 ...
					 "<td>"+is_upgrade+"</td>"+
					 "<td>"+is_lock+"</td>"+
					 "<td>"+"<a href='chgAgentGroup?id="+id+"'>修改</a><a href='delAgentGroup?id="+id+"'>删除</a>"+"</td>"+ 
