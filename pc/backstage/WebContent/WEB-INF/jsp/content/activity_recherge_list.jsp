		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
									充值赠送首单返现规则	<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="*">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">平台活动</a><i class="icon-angle-right"></i></li>
							<li><a href="#">充值赠送首单返现规则 </a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insActRecherge"><i class="icon-pencil"></i>新增充值赠送首单返现规则  </a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var recherge_limit =item.recherge_limit;
					var recherge_give =item.recherge_give;
					var first_give =item.first_give;
					var max_count =item.max_count;
					var now_count =item.now_count;
					...
					var add_time =item.add_time;
					 ...
					 "<td>"+"<a href='readActRecherge?id="+id+"'>修改</a>&nbsp;<a href='delActRecherge?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
