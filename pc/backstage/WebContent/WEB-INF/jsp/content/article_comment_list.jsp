					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticleComment"><i class="icon-pencil"></i>新增内容评论信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class="row_fluid ">
									<ul>
									    ...
									    <li>评论内容：<input type="text" id="content" class="small m-wrap" ></li>
