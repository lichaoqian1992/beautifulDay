...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">站内短消息管理</a><i class="icon-angle-right"></i></li>
							<li><a href="#">查看站内短消息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">站内短消息</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="post_user_role_type" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="accept_user_role_type" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">角色对应值：</label>
	...
	function infoset(){
		...
		var id=usermessageinfo.id;
		var type=usermessageinfo.type;
		var post_user_id=usermessageinfo.post_user_id;
		var post_user_role_type=usermessageinfo.post_user_role_type;
		var post_user_role_value=usermessageinfo.post_user_role_value;
		var accept_user_id=usermessageinfo.accept_user_id;
		var accept_user_role_type=usermessageinfo.accept_user_role_type;
		var accept_user_role_value=usermessageinfo.accept_user_role_value;
		var is_read=usermessageinfo.is_read;
		var title=usermessageinfo.title;
		var content=usermessageinfo.content;
		var post_time=usermessageinfo.post_time;
		var read_time=usermessageinfo.read_time;
		var is_del=usermessageinfo.is_del;


		$("#hiddenid").val(id);
		$("#type").val(type);
		$("#post_user_id").val(post_user_id);
		$("#post_user_role_type").val(post_user_role_type);
		$("#post_user_role_value").val(post_user_role_value);
		$("#accept_user_id").val(accept_user_id);
		$("#accept_user_role_type").val(accept_user_role_type);
		$("#accept_user_role_value").val(accept_user_role_value);
		$("#is_read").val(is_read);
		$("#title").val(title);
		$("#content").val(content);
