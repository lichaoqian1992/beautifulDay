					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserMessage"><i class="icon-pencil"></i>站内短消息</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					/*  "<td>"+post_user_id+"</td>"+
					 ...
					 "<td>"+read_time+"</td>"+
					 "<td>"+is_delstr+"</td>"+
					 "<td>"+"<a href='readUserMessage?id="+id+"'>修改</a><a href='delUserMessage?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
