					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insRecAddr"><i class="icon-pencil"></i>新增用户收货地址</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					/*  "<td>"+longitude+"</td>"+
					 ...
					 "<td>"+sex+"</td>"+
					 "<td>"+doorplate+"</td>"+
					 "<td>"+"<a href='readRecAddr?id="+id+"'>修改</a><a href='delRecAddr?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
