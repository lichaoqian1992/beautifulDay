						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a href="insUserGroup" class="btn blue"><i class="icon-pencil"></i>新增</a>
				...
				$.each(data,function(i, branditem) {
									...
									$("#tablebody").append(
													"<tr><td>"
															...
															+ "</td><td>"
															+ tf(is_lock)
															+"</td>"+"<td><a href='readUserGroup?id="+id+"'>修改</a>&nbsp<a href='delUserGroup?id="+id+"'>删除</a>"+"</td>"+ 
															+ "</tr>");
			...
			success : function(data) {
				...
				$.each(listdate,function(i,item){
					...
					var row ="<tr>"+
					 ...
					 "<td>"+is_upgrade+"</td>"+
					 "<td>"+is_lock+"</td>"+
					 "<td>"+"<a href='chgUserGroup?id="+id+"'>修改</a><a href='delUserGroup?id="+id+"'>删除</a>"+"</td>"+ 
