		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
										登录用户列表<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="*">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">登录用户管理</a><i class="icon-angle-right"></i></li>
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a  class="btn blue" href="insLocalUser"><i class="icon-pencil"></i>新增用户</a>
	...
	function setinfo(){
		...
		$.each(userList,function(i,item){
			...
			var rowhtml ="<tr>"+
			 ...
			 "<td>"+password+"</td>"+
			 "<td>"+statestr+"</td>"+
			 "<td>"+"<a href='readLocalUser?id="+id+"'>修改</a>"+"&nbsp;"+"<a href='delLocalUser?id="+id+"'>删除</a>" +"</td>"+
			 "</tr>";
			tablehtml+=rowhtml;
