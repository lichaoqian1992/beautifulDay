          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insAdvertNavigation"><i class="icon-pencil"></i>新增用户</a>
                </div>
              </div>
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          var show_type=item.show_type;
           ...
           "<td>"+show_type+"</td>"+
           "<td>"+"<a href='readAdvertNavigation?id="+id+"'>修改</a><a href='delAdvertNavigation?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
