										...
										<div class="form-group">
											...
											<div class="col-lg-8 spec_pt1">
												<div style="display: block;">
													<table id="attritable" class="table table-bordered properties_table">
														<thead>
															<tr>
																<th>序号</th>
																<th>名称</th>
													...
													<div><a href="javascript:;" id="attri_add"><img src="img/u865.png"></a></div>
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="attri_add">
											<div class="form-horizontal" >
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control attri_add_name">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">数值：</label>
													<div class="col-lg-6">
														<input type="text" class="form-control attri_add_num">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">必填：</label>
													<div class="col-lg-6">
														<input type="checkbox" class="attri_add_check" value="">
													</div>
												</div>
												<div class="form-group">
													<div class="col-lg-offset-3 col-lg-9">
														<button class="btn btn-w-m btn-success save_add" type="submit">保
															存</button>
										...
										<div class="attri_update">
											<div class="form-horizontal">
												<div class="form-group">
													<label class="col-lg-3 control-label">名称：</label>
													<div class="col-lg-6">
														<input type="text" class="form-control properties_name" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">数值：</label>
													<div class="col-lg-6">
														<input type="text" class="form-control properties_num" value="">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">必填：</label>
													<div class="col-lg-6">
														<input type="checkbox" value="" class="properties_check">
													</div>
												</div>
												<div class="form-group">
													<div class="col-lg-offset-3 col-lg-9">
														<button class="btn btn-w-m btn-success success_update" type="submit">保
															存</button>
		...
		$(document).ready(function (){
	      ...
	      //保存添加属性值
	        $(".save_add").click(function() {
                ...
                var tr = '<tr><td>' + tr_num + '</td><td>' + attri_add_name + '</td><td>' + attri_add_num + '</td><td>' + checke + '</td><td><a class="attri_update_b">编辑</a>&nbsp;<a class="attri_delete_b">删除</a></td></tr>';
	      ...
	      //删除属性
            ...
            $(".properties_table").on("click",".attri_update_b", function() {
          	...
          	//删除属性
            $(".properties_table").on("click",".attri_delete_b", function() {
                trNum = $(this).parent().parent().parent().find('tr').index($(this).parent().parent()[0])+ 1;//获得table的行号
                $('.properties_table').find('tr:eq(' + (trNum) + ')').remove();
            });
            /*操作新添加的元素*/
		...
		/* $('#attri_add').on('click', function(){
		 ...
		 function settable(){
			 ...
			 $.each(attrilist,function(i, attriitem) {
				...
				"<td>"+"<a href='javascript:;' class='attri_update_a'>编辑</a>"+"&nbsp;"+"<a class='attri_delete'>删除</a>"+"</td>"+
				"</tr>";
