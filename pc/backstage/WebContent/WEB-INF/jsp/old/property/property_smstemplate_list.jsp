	...
	function filltable(){
		...
		$.each(datalist,function(i,item){
			...
			var rowstr ="<tr>"+
						...
						"<td>"+content+"</td>"+
						"<td>"+is_sysstr+"</td>"+
						"<td>"+"<a href=chgSmsTemplate?id="+id+">修改</a>&nbsp<a href=delSmsTemplate?id="+id+">删除</a>"+"</td>"+
						"</tr>";
