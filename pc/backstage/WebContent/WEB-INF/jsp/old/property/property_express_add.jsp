								...
								<div class="ibox-content">
									...
									<div class="form-horizontal">
										<div class="form-group">
											<label class="col-lg-2 control-label">快递名称：</label>
										...
										<div class="form-group">
											<label class="col-lg-2 control-label">物流编码：</label>
										...
										<div class="form-group">
											<label class="col-lg-2 control-label">快递网址：</label>
											
											<div class="col-lg-5 ">
												<input type="text" id="webstr" class="form-control">
											</div>
										</div>
