										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<div class="row">
													...
													<span class="_span">发送手机号：</span>
													<div class="col-md-2">
														<input type="text" id="mobilestr"  class="form-control">
													</div>
													<a id="querybutton" onclick="querylog()"class="btn btn-primary search_sub">查询</a>
