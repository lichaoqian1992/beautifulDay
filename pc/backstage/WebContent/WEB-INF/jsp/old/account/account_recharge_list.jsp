								...
								<div class="ibox-content">
									...
									<form class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-lg-1 control-label lable_a">充值用户ID：</label>
											<div class="col-lg-10">
												<div class="row">
													<div class="col-md-2">
													...
													<span class="_span">充值到账户：</span>
													<div class="col-md-2">
														<input type="text" id="accountidstr" placeholder="" class="form-control">
														
													</div>
													<span class="_span">充值订单号：</span>
													<div class="col-md-2">
														<input type="text" id="ordernostr" placeholder="" class="form-control">
														
													</div>
													
													<span class="_span">订单状态：</span>
													<div class="col-md-2">
				...
				if(freshdata.status ==0){
					...
					$.each(data,function(i,item){
						...
						rowhtml ="<tr>"+
								 ...
								 "<td>"+voucher+"</td>"+
								 "<td>"+is_del+"</td>"+
								 "<td>"+"<a href='updRecharge?id="+id+"'>修改</a>"+"</td>"+
								 "</tr>";
						tablehtml+=rowhtml;
