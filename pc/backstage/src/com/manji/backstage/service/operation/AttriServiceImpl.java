...
import com.manji.backstage.mapper.operation.AttriMapper;
...
//	}
	...
	@Override
	public Attri getAttri(int category_id) {

		return mapper.getAttri(category_id);
	}
