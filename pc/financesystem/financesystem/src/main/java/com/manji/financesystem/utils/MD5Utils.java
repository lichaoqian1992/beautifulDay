...
public class MD5Utils {
    ...
    public static void main(String[] args) {
        ...
        String str =getMD5("http://pay.manji.com/javaio.ashx?accessKey=javamanager&action=UserWithdrawals&idList=1&noncestr=1488873209790&remark=用户撤销提现&stats=1&tranSN=201703071553291");
