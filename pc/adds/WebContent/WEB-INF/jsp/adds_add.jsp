        ...
        <ul class="nav" id="side-menu">
          ...
          <li class="active">
              ...
              <ul class="nav nav-second-level">
                  ...
                  <li class="active"><a href="toAddAdds">新增广告</a>
                  </li>
                  <li class=""><a href="toAddPCAdds">新增PC广告</a>
                  </li>
              </ul>
          </li>
          <li>
                ...
                <div class="col-sm-7">
                 <!--  <div class="radio col-sm-3 i-checks">
                  ...
                  <div class="radio col-sm-3 i-checks">
                    <label for="app">
                      <div class="iradio_square-green">
                        <input type="radio" value="1" class="channel" name="channel" id="app">
                      </div> 
                      <i></i> APP端
                    </label>
                  </div>
                  ...
                  <!-- <input type="text" maxlength="2" class="form-control" id="pl_id" name="pl_id" required="required" placeholder="广告位为纯数字"> -->
                	<select class="form-control" required="required" name="pl_id"id="pl_id" >
                     <option value="1">APP首页</option>
                      <option value="10">APP食品茶酒</option>
                      <option value="11">APP农特产品</option>
                      <option value="12">APP个妆美护</option>
                      <option value="13">APP遥控玩具</option>
                      <option value="14">APP户外运动</option>
                      <option value="15">APP办公用品</option>
                      <option value="16">APP珠宝首饰</option>
                      <option value="3">APP酒店住宿</option>
                      <!-- <option value="2">餐饮美食</option>
                      <option value="3">休闲娱乐</option>
						<option value="5">旅游观光</option>
						<option value="6">日用百货</option>
						<option value="7">外卖服务</option>
						<option value="8">农村电商</option>
