...
//        code="0001";
//        sign=MD5Utils.getMD5(username+password+code+"manji");
    ...
    findUserByName(@RequestParam("name") String name){
        ...
        String j= JSON.toJSONString(userList);
    ...
    @ResponseBody
    public JSONArray findExamineUser(@RequestParam("userId") int userId,@RequestParam("path") String path){
