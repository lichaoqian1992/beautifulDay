...
/**
 * Created by karben on 16/8/31.(一网通支付接口)
 */
public class PayInterfaceUtil {
    /**
     * httpclient请求
     */
    public final static String SUCCESS = "success";//正确状态
    public final static String ERROR = "error";//错误状态
    public final static String ATURL = "http://121.15.180.72/CmbBank_B2B/UI/DIDI/DoBusiness.ashx?";//测试地址
    //public final static String ATURL = "http://pay.manjiwang.com/javaio.ashx?";//测试地址
