...
/**
 * Created by pudding on 2017-1-17.SqlServer(用于同步提现)
 * 用户提现记录信息DO
 */
public class UserWithdrawalsDO {
    ...
    public String getTixianYonghu() {
        return tixianYonghu;
    }

    public void setTixianYonghu(String tixianYonghu) {
        this.tixianYonghu = tixianYonghu;
    }
}
