...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selOrderPartner">第三方支付信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改第三方支付信息</span>
								</div>
							</div>
							<div class="portlet-body form">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="order_money" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													<label class="control-label">异步通知次数：</label>
													<div class="controls">
														<input id="notify_number" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">异步通知结果：</label>
													<div class="controls">
														<input id="notify_result" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">异步通知状态：</label>
													<div class="controls">
                                ...
                                <option value="2">已送达</option>
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="pay_time" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													<label class="control-label">退款成功时间：</label>
													<div class="controls">
														<input id="over_time" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selOrderPartner">返回</a>
	...
	function infoset(){
		...
		var orderpartnerinfo=${orderpartnerinfo };
		
		    var id=orderpartnerinfo.id;
        var user_id=orderpartnerinfo.user_id;
        var user_role_type=orderpartnerinfo.user_role_type;
        var user_role_value=orderpartnerinfo.user_role_value;
        var partner_channel=orderpartnerinfo.partner_channel;
        var order_no=orderpartnerinfo.order_no;
        var order_title=orderpartnerinfo.order_title;
        var order_money=orderpartnerinfo.order_money;
        var pay_status=orderpartnerinfo.pay_status;
        var return_url=orderpartnerinfo.return_url;
        var notify_url=orderpartnerinfo.notify_url; 
        var notify_number=orderpartnerinfo.notify_number;
        var notify_result=orderpartnerinfo.notify_result;
        var notify_status=orderpartnerinfo.notify_status;
        var add_time=orderpartnerinfo.add_time;
        var pay_time=orderpartnerinfo.pay_time;
        var back_time=orderpartnerinfo.back_time;
        var over_time=orderpartnerinfo.over_time;
        var is_del=orderpartnerinfo.is_del;
		...
		$("#notify_number").val(notify_number);
		$("#notify_result").val(notify_result);
	...
	$("#subbutton").on("click",function(){
		...
		data : {
			...
			notify_number:$("#notify_number").val(),
			notify_result:$("#notify_result").val(),
