					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderQueue"><i class="icon-pencil"></i>新增订单任务队列信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	completiontime=item.completiontime;
					 ...
					 "<td>"+"<a href='readOrderQueue?id="+id+"'>修改</a><br><a href='delOrderQueue?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
