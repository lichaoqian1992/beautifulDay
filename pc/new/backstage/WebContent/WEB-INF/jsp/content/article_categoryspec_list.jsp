...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticleCategorySpec"><i class="icon-pencil"></i>新增分类所有的规格信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										...
										<li>字段ID：<input type="text" id="spec_id" class="small m-wrap" ></li>
	...
	if($("#spec_id").val()!=""){
		ajaxdatas+="&spec_id="+$("#spec_id").val();
	}
	
	$.ajax({
		type : "GET",
		url : "queryArticleCategorySpec",
		dataType : "json",
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var spec_id =item.spec_id;
					 ...
					 "<td>"+"<a href='readArticleCategorySpec?id="+id+"'>修改</a>&nbsp;<a href='delArticleCategorySpec?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
