...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selActIndex">首页推荐活动信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改首页推荐活动信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var add_content_type =actindex.add_content_type ;
		...
		$("#add_content_type").val(add_content_type);
	...
	$("#subbutton").on("click",function(){
		...
		data : {
			...
			add_content_type:$("#add_content_type").val(),
