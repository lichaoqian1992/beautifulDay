				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selActIndUser">首页推荐活动申请审核信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">新增首页推荐活动申请审核信息</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="addActIndUser" class="form-horizontal" method="POST" enctype="multipart/form-data">
												
												<div class="control-group">
													<label class="control-label">活动编号：</label>
													<div class="controls">
														<input id="ndex_id" type="text" name="ndex_id"	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														...
														<textarea id="site_id" type="text" name="site_id"	class="m-wrap large"></textarea>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														...
														<textarea id="add_time" type="text" name="add_time"	class="m-wrap large"></textarea>
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="content_value" type="text" name="content_value"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="role_type" type="text" name="role_type"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">申请角色值：</label>
													<div class="controls">
														<input id="role_value" type="text" name="role_value"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="show_time" type="text" name="show_time"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">展示结束时间：</label>
													<div class="controls">
														<input id="show_endtime" type="text" name="show_endtime"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">自定义链接：</label>
													<div class="controls">
														<input id="custom_url" type="text" name="custom_url"	class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
