...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selActAdvert">广告活动信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改广告活动信息</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updActAdvert" class="form-horizontal" method="POST" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input id="end_time" type="text" name="end_time"	class="m-wrap large"/>
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selActAdvert">返回</a>
	...
	function infoset(){
		...
		var actadvert=${actadvert };
		
		var id=actadvert.id;
		var begin_time  =actadvert.begin_time ;
		var end_time      =actadvert.end_time ;
		var act_area     =actadvert.act_area ;
		var title =actadvert.title ;
		var pics =actadvert.pics ;
		var content =actadvert.content ;
		var discount =actadvert.discount ;
		var status =actadvert.status ;
		var add_time =actadvert.add_time ;
