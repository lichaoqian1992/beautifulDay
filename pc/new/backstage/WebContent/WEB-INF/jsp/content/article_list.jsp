					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticle"><i class="icon-pencil"></i>新增基础内容信息</a>
								</div>
							</div>
			                ...
			                <li class="span2">标题：<input type="text" id="title" class="small m-wrap" >
			                </li>
			                <li class="span2">内容状态：
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var user_category_id=item.user_category_id;
					...
					switch(is_del){
					 ...
					 "<td>"+is_del+"</td>"+
					 /* "<td>"+remark+"</td>"+ */
					 "<td>"+"<a href='readArticle?id="+id+"'>修改</a><a href='delArticle?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
