...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改文章派生的图片相册类附加信息</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updArticleAlbums" class="form-horizontal" method="POST" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														<img style="width:100px;" id=pics2>
	...
	function infoset(){
		...
		var articlealbums=${articlealbums };
		
		var id=articlealbums.id;
		var article_id    =articlealbums.article_id;
		var thumb_path    =articlealbums.thumb_path;
		var original_path =articlealbums.original_path;
		var remark        =articlealbums.remark;
		var add_time      =articlealbums.add_time;
		

		$("#hiddenid").val(id);
		$("#article_id").val(article_id);
		$("#pics").attr("src",thumb_path);
		$("#pics2").attr("src",original_path);
		$("#icon").val(thumb_path);
		$("#icon2").val(original_path);
		$("#remark").val(remark);
