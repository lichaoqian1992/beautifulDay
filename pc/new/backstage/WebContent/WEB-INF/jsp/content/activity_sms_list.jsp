					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insActSms"><i class="icon-pencil"></i>新增短信活动信息</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					switch(status){
					 ...
					 "<td>"+"<a href='readActSms?id="+id+"'>修改</a>&nbsp;<a href='delActSms?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
