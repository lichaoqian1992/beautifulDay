...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改短信活动信息</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updActSms" class="form-horizontal" method="POST" enctype="multipart/form-data">
	...
	function infoset(){
		...
		var id=actsms.id;
		var begin_time  =actsms.begin_time ;
		var end_time      =actsms.end_time ;
		var act_area     =actsms.act_area ;
		var title =actsms.title ;
		var pics =actsms.pics ;
		var content =actsms.content ;
		var discount =actsms.discount ;
		var status =actsms.status ;
		var add_time =actsms.add_time ;
