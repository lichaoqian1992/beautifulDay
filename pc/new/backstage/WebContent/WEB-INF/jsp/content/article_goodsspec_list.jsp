				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selArticleGoodsSpec">文章派生的商品类所选规则规格信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticleGoodsSpec"><i class="icon-pencil"></i>新增文章派生的商品类所选规则规格信息</a>
								</div>
							</div>
							...
							<div class="row_fluid ">
								<ul>
					                ...
					                <li>规格标题：<input type="text" id="title" class="small m-wrap" ></li>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	img_url=item.img_url;
					 ...
					 "<td>"+"<a href='readArticleGoodsSpec?id="+id+"'>修改</a><br><a href='delArticleGoodsSpec?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
