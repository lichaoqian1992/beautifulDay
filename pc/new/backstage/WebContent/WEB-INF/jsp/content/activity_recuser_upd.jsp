...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selActRecUser">充值赠送首单返现参与用户</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">充值赠送首单返现参与用户</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var actrecuser=${actrecuser };
		
		var id=actrecuser.id;
		var user_id  =actrecuser.user_id ;
		var activity_user_id      =actrecuser.activity_user_id ;
		var recherge_give     =actrecuser.recherge_give ;
		var first_give =actrecuser.first_give ;
		var first_state =actrecuser.first_state ;
		var first_time =actrecuser.first_time ;
		var first_order_no =actrecuser.first_order_no ;
		var first_order_type =actrecuser.first_order_type ;
		var state =actrecuser.state ;
		var add_time =actrecuser.add_time ;

		$("#hiddenid").val(id);
		$("#user_id").val(user_id);
		$("#activity_user_id").val(activity_user_id);
		$("#recherge_give").val(recherge_give);
		$("#first_give").val(first_give);
		$("#first_state").val(first_state);
		$("#first_time").val(first_time);
		$("#first_order_no").val(first_order_no);
		$("#first_order_type").val(first_order_type);
		$("#state").val(state);
