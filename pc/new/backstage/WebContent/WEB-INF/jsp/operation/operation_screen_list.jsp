          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insScreen"><i class="icon-pencil"></i>新增筛选信息</a>
                </div>
              </div>
              ...
              <div class="row-fluid ">
                ...
                <div class="span2">具体内容：
                	<input type="text" id="content" class="small m-wrap" >
                </div>
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          switch(status){
           ...
           "<td>"+content+"</td>"+
           "<td>"+status+"</td>"+
           "<td>"+"<a href='readScreen?id="+id+"'>修改</a>&nbsp;<a href='delScreen?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
