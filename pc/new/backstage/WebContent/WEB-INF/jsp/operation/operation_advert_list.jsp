...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insAdvert"><i class="icon-pencil"></i>新增广告位信息</a>
                </div>
              </div>
              ...
              <div class="row-fluid ">
                ...
                <div class="span2">广告类别：
                	<select class="m-wrap small" id="advert_type">
  ...
  if($("#advert_type").val()!=""){
	    ajaxdatas+="&advert_type="+$("#advert_type").val();
	  }
    ...
    success : function(freshdata) {
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          var show_numbers=item.show_numbers;
          var buy_numbers=item.buy_numbers;
          var remark=item.remark;
          var type=item.type;
          var price_remark=item.price_remark;
          var view_width=item.view_width;
          var view_height=item.view_height;
          var target=item.target;
          var advert_type=item.advert_type;
          ...
          switch(advert_type){
           ...
           "<td>"+advert_type+"</td>"+
           "<td>"+add_time+"</td>"+
           "<td>"+"<a href='readAdvert?id="+id+"'>修改</a><br><a href='delAdvert?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
