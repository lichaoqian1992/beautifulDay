          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insApoScreen"><i class="icon-pencil"></i>新增全国地区筛选</a>
                </div>
              </div>
              ...
              <div class="portlet-body">
	              <div class=row_fluid>
						<ul>
							<li>类别编号：<input type="text" id="name" class="small m-wrap" ></li>
						   	<li>内容类型：
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          var typeStr = "";
           ...
           "<td>"+typeStr+"</td>"+
           "<td>"+sort_id+"</td>"+
           "<td>"+"<a href='readApoScreen?id="+id+"'>修改</a>&nbsp<a href='delApoScreen?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
