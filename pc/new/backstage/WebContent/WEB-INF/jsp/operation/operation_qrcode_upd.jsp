...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">修改二维码信息</span>
                </div>
              </div>
  ...
  function infoset(){
    ...
    var id=qrcodeinfo.id;
    var type=qrcodeinfo.type;
    var name=qrcodeinfo.name;
    var amount=qrcodeinfo.amount;
    var add_time=qrcodeinfo.add_time;
    var invalid_time=qrcodeinfo.invalid_time;
    var status=qrcodeinfo.status;
    var content=qrcodeinfo.content;
    var user_id=qrcodeinfo.user_id;
    var user_role_type=qrcodeinfo.user_role_type;
    var user_role_value=qrcodeinfo.user_role_value;
