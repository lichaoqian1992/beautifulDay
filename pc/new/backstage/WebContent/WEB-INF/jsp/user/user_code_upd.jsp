...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selUserCode">用户随机码信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改用户随机码信息</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
												 ...
												 <div class="control-group">
													<label class="control-label">生成码类别：</label>
													<div class="controls">
														<select id="type">
												...
												<div class="control-group">
													<label class="control-label">生成的字符串：</label>
													<div class="controls">
														<input id="str_code" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="eff_time" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selUserCode">返回</a>
	...
	function infoset(){
		...
		var	user_id=usercode.user_id;
		var	user_role_type=usercode.user_role_type;
		var	user_role_value=usercode.user_role_value;
		var	type=usercode.type;
		var	str_code=usercode.str_code;
		var	count=usercode.count;
		var	status=usercode.status;
		var	user_ip=usercode.user_ip;
		var	eff_time=usercode.eff_time;
		var	add_time=usercode.add_time;
