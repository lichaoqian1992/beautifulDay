...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改用户标识申请信息</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updUserFromValue" class="form-horizontal" method="POST"
	...
	function infoset(){
		...
		var userfromvalue=${userfromvalue };
		
		var id=userfromvalue.id;
		
		var	user_id=userfromvalue.user_id;
		var	user_role_type=userfromvalue.user_role_type;
		var	user_role_value=userfromvalue.user_role_value;
		var	from_value=userfromvalue.from_value;
		var	wechat_id=userfromvalue.wechat_id;
		var	img_url=userfromvalue.img_url;
		var	from_type=userfromvalue.from_type;
		var	yx_time=userfromvalue.yx_time;
		var	add_time=userfromvalue.add_time;
		var	status=userfromvalue.status;
		var	is_del=userfromvalue.is_del;
		var	subscribe_count=userfromvalue.subscribe_count;
		var	reg_count=userfromvalue.reg_count;
		...
		$("#status").val(status);
		$("#is_del").val(is_del);
		$("#subscribe_count").val(subscribe_count);
