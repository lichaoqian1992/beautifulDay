...
<body class="page-header-fixed">
        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <ul class="breadcrumb">
              ...
              <li><a href="#">系统角色管理</a><i class="icon-angle-right"></i></li>
              <li><a href="selLocalRole">新增系统角色</a></li>
            </ul>
          </div>
        </div>
                      ...
                      <form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<span style="color:green;margin-left:1%">如多个，请用'，'隔开</span>
													</div>
												</div>
  ...
  function ignore(commaStr){
	  if(commaStr.indexOf("，")>-1){
		  var newStr = commaStr.replace("，",",");
		  return newStr;
	  }else{
		  return commaStr;
	  }
