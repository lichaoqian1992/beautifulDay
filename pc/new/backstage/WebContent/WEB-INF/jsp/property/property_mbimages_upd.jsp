...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改用户发布所用图片模板</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updMbImages" class="form-horizontal" method="POST"
	...
	function infoset(){
		...
		var mbimages=${mbimages };
		
		var id=mbimages.id;
		
		var	category_id=mbimages.category_id;
		var	keywords=mbimages.keywords;
		var	url=mbimages.url;
		var	status=mbimages.status;
		var	add_time=mbimages.add_time;
		var	update_time=mbimages.update_time;
		var	remark=mbimages.remark;
