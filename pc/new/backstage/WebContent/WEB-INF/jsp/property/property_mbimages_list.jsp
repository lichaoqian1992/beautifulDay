					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insMbImages"><i class="icon-pencil"></i>新增用户发布所用图片模板</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					default:
					 ...
					 "<td>"+category_id+"</td>"+
					 "<td>"+keywords+"</td>"+
					 "<td><img src="+url+" style='height:100px'/></td>"+
					 "<td>"+stateStr+"</td>"+
					 "<td>"+add_time+"</td>"+
					 "<td>"+update_time+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readMbImages?id="+id+"'>修改</a><br><a href='delMbImages?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
