					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insExpress"><i class="icon-pencil"></i>新增快递物流方式信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										<li>快递名称：<input type="text" id="title" class="small m-wrap" ></li>
										<li>快递网址：<input type="text" id="website" class="small m-wrap" ></li>
										<li>是否锁定：
				...
				$.each(data,function(i,item){
					...
					case 1:
					 ...
					 var rowhtml ="<tr>"+
						...
						"<td>"+sort_id+"</td>"+
						"<td>"+is_lockstr+"</td>"+
						"<td>"+"<a href='readExpress?id="+id+"'>修改</a>&nbsp<a href='delExpress?id="+id+"'>删除</a>"+"</td>"+
						"</tr>";
