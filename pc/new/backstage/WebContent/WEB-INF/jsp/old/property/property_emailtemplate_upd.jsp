			...
			<div id="maincontent">
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						...
						<ol class="breadcrumb">
							<li><a>主页</a></li>
							<li><a href="selAttri">邮件管理</a></li>
							<li><strong>修改邮件模板</strong></li>
						</ol>
					</div>
							...
							<div class="ibox float-e-margins">
								<div class="ibox-content">
									...
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-lg-2 control-label">邮件标题：</label>
											
											<div class="col-lg-5 ">
												<input type="text" id="mailtitle" class="form-control">
											</div>
										</div>
	...
	<script>
		...
		$("#subbutton").on("click",function(){
		 ...
		 function infoset(){
			 ...
			 var call_index=info.call_index;
			 var mail_title=info.mail_title;
			 var content=info.content;
			 var is_sys=info.is_sys;
			 
			 $("#hiddenid").val(id);
			 $("#titlename").val(title);
			 $("#callname").val(call_index);
			 $("#mailtitle").val(mail_title);
