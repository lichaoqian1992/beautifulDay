			...
			<div id="maincontent">
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						...
						<ol class="breadcrumb">
							<li><a>主页</a></li>
							<li><a href="selAttri">访问日志</a></li>
							<li><strong>签到日志</strong></li>
						</ol>
					</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<div class="row">
													...
													<span class="_span">签到时间：</span>
													<div class="col-md-2">
														<input type="text" id="viewtimestr" placeholder="yyyy-mm-dd" class="form-control">
													</div>
