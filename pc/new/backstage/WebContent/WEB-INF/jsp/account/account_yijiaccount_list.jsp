...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insYiJiAccount"><i class="icon-pencil"></i>新增易极付账户信息</a>
								</div>
							</div>
                  ...
                  <li>用户名称：<input type="text" id="user_name" class="small m-wrap" ></li>
                  <li>手机号：<input type="text" id="mobile" class="small m-wrap" ></li>
                  <li>易极付用户ID:<input type="text" id="yjf_user_id" class="small m-wrap" ></li>
                  <li>登录名称:<input type="text" id="yjf_user_name" class="small m-wrap" ></li>
                  <li>是否删除:
	...
	if($("#user_name").val()!=""){
		ajaxdatas+="&user_name="+$("#user_name").val();
	}
	if($("#yjf_user_id").val()!=""){
		ajaxdatas+="&yjf_user_id="+$("#yjf_user_id").val();
	}	
	if($("#yjf_user_name").val()!=""){
		ajaxdatas+="&yjf_user_name="+$("#yjf_user_name").val();
	}
	if($("#is_del").val()!=""){
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var yjf_user_id=item.yjf_user_id;
					var yjf_user_name=item.yjf_user_name;
					var result_source=item.result_source;
					...
					switch(is_del){
					 ...
					 "<td>"+add_time+"</td>"+
					 "<td>"+One+"</td>"+
					 "<td>"+"<a href='readYiJiAccount?id="+id+"'>修改</a>&nbsp;<a href='delYiJiAccount?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
