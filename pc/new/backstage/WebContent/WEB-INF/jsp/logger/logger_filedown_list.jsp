				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title" style="heigth:20px">
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var add_time =item.add_time;
					 ...
					 "<td>"+file_name+"</td>"+
					 "<td>"+add_time+"</td>"+
					 "<td>"+"<a href='readFileDownLog?id="+id+"'> 修改</a>"+"</td>"+
					 "</tr>";
