        ...
        <div class="row-fluid">
         <div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selUserRoleMedal">用户角色荣誉勋章信息</a></li>
						</ul>
					</div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增用户角色荣誉勋章信息</span>
                </div>
              </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                     ...
                     <form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">勋章/荣誉值：</label>
													<div class="controls">
														<input id="medal_value" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selUserRoleMedal">返回</a>
