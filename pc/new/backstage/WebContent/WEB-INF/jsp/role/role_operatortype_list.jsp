					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insRoleOperatorType"><i class="icon-pencil"></i>新增角色后台管理操作员类别信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	role_type_value=item.role_type_value;
					...
					switch (is_sys){
					 ...
					 "<td>"+user_id+"</td>"+
					 "<td>"+role_type+"</td>"+
					 "<td>"+role_type_value+"</td>"+
					 "<td>"+is_sys+"</td>"+
					 "<td>"+"<a href='readRoleOperatorType?id="+id+"'>修改</a><br><a href='delRoleOperatorType?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
