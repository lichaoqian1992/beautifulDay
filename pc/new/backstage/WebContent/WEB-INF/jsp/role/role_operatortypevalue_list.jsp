...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">角色后台管理员操作类别对应权限值</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insRoleOperatorTypeValue"><i class="icon-pencil"></i>新增角色后台管理员操作类别对应权限值</a>
								</div>
							</div>
	...
	$.ajax({
		type : "GET",
		url : "queryRoleOperatorTypeValue",
		dataType : "json",
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	action_type=item.action_type;
					 ...
					 "<td>"+nav_name+"</td>"+
					 "<td>"+action_type+"</td>"+
					 "<td>"+"<a href='readRoleOperatorTypeValue?id="+id+"'>修改</a><br><a href='delRoleOperatorTypeValue?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
