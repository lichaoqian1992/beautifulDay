					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserRole"><i class="icon-pencil"></i>新增用户角色信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	operator_type_id=item.operator_type_id;
					...
					switch (is_online){
					 ...
					 "<td>"+remark+"</td>"+
					 "<td>"+is_online+"</td>"+
					 "<td>"+"<a href='readUserRole?id="+id+"'>修改</a><br><a href='delUserRole?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
