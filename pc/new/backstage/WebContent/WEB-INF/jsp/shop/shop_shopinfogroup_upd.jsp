...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改商家集团信息身份</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="group_name" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">集团管理类型：</label>
													<div class="controls">
														<input id="manager_type" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
	...
	function infoset(){
		...
		var	user_role_type=shopinfo.user_role_type;
		var	user_role_value=shopinfo.user_role_value;
		var	group_name=shopinfo.group_name;
		var	manager_type=shopinfo.manager_type;
