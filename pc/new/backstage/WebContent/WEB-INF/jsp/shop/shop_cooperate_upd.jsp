      ...
      <div class="container-fluid">
        ...
        <div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selCooperate">用户业务申购信息</a></li>
						</ul>
					</div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增用户业务申购信息</span>
                </div>
              </div>
  ...
  $(document).ready(function() {    
        ...
        $.ajax({
            ...
            success : function(data) {
              ...
              $('#channel_id option[value="'+cooper.channel_id+'"]').attr('selected',true); 
            }
      	});
    });
