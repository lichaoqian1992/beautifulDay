...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增系统业务库</span>
                </div>
              </div>
                    ...
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="#" class="form-horizontal">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="valid_time" type="text"   class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">默认保证金：</label>
                          <div class="controls">
                            <input id="deposit" type="text"  class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">默认手续费：</label>
                          <div class="controls">
                            <input id="poundage" type="text"  class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="form-actions">
                          ...
                          <a type="button" class="btn" href="selBusiness">返回</a>
  ...
  function infoset(){
    ...
    var id=businessinfo.id;
    var name=businessinfo.name;
    var call_index=businessinfo.call_index;
    var channel_id=businessinfo.channel_id;
    var content=businessinfo.content;
    var role_type=businessinfo.role_type;
    var valid_time=businessinfo.valid_time;
    var deposit=businessinfo.deposit;
    var poundage=businessinfo.poundage;
    var percentage=businessinfo.percentage;
    var agreement=businessinfo.agreement;
    var status=businessinfo.status;
    var add_time=businessinfo.add_time;
