					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticleCategoryUser"><i class="icon-pencil"></i>新增用户自定义分类信息记录</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	seo_description=item.seo_description;
					 ...
					 "<td>"+"<a href='readArticleCategoryUser?id="+id+"'>修改</a>&nbsp;<a href='delArticleCategoryUser?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
