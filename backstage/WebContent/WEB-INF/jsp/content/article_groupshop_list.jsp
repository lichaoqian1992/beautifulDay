					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insArticleGroupshop"><i class="icon-pencil"></i>新增集团批量操作记录</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					switch(is_del){
					 ...
					 "<td>"+article_id+"</td>"+
					 "<td>"+is_del+"</td>"+
					 "<td>"+"<a href='readArticleGroupshop?id="+id+"'>修改</a><br><a href='delArticleGroupshop?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
