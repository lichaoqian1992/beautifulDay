...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改内容评论信息记录</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updArticleComment" class="form-horizontal" method="POST" enctype="multipart/form-data">
	...
	function infoset(){
		...
		for(var i=0;i<pics.split(",").length;i++){
			xx += "<img class='aa' style='width:100px;' src='"+pics.split(",")[i]+"'>&nbsp;&nbsp;&nbsp;&nbsp;";
