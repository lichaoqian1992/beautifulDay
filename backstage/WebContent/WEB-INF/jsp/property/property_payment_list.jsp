					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insPayment"><i class="icon-pencil"></i>新增支付方式信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								 <div class=row_fluid>
									<ul>
										<li>支付方式：<input type="text" id="title" class="small m-wrap" ></li>
										<li>支付类型：
				...
				$.each(data,function(i,item){
					...
					default:
					 ...
					 var rowhtml  ="<tr>"+
						...
						"<td>"+is_lockstr+"</td>"+
						"<td>"+api_path+"</td>"+
						"<td>"+"<a href='readPayment?id="+id+"'>修改</a>&nbsp;<a href='delPayment?id="+id+"'>删除</a>"+"</td>"+
						"</tr>";
