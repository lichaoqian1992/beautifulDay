					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insMbShopMatter"><i class="icon-pencil"></i>新增商家发布内容购买须知等模板</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					default:
					 ...
					 "<td>"+c_content+"</td>"+
					 "<td>"+stateStr+"</td>"+
					 "<td>"+"<a href='readMbShopMatter?id="+id+"'>修改</a><br><a href='delMbShopMatter?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
