...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selMbCategory">用户自定义分类模板</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改自定义分类模板</span>
								</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">模板分类名称：</label>
													<div class="controls">
														<textarea id="mb_content" type="text" 	class="m-wrap large" ></textarea><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selMbCategory">返回</a>
	...
	function infoset(){
		...
		var mbcategory=${mbcategory };
		
		var id=mbcategory.id;
		
		var	category_id=mbcategory.category_id;
		var	mb_content=mbcategory.mb_content;
		var	status=mbcategory.status;
		var	add_time=mbcategory.add_time;
		var	update_time=mbcategory.update_time;
		var	remark=mbcategory.remark;


	 	$("#hiddenid").val(id);
	 	$("#category_id").val(category_id);
	 	$("#mb_content").val(mb_content);
	 	$("#status").val(status);
