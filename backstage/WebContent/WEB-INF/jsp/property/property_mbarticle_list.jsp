...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insMbArticle"><i class="icon-pencil"></i>新增用户发布内容模板</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										...
										<li>关键字：<input type="text" id="keywords" class="small m-wrap" ></li>
	...
	if($("#keywords").val()!=""){
		ajaxdatas+="&keywords="+$("#keywords").val();
	}
	if($("#title").val()!=""){
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					default:
					 ...
					 "<td>"+update_time+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readMbArticle?id="+id+"'>修改</a><br><a href='delMbArticle?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
