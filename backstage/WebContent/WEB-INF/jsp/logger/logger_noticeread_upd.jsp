...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
								用户动态消息读取记录		<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">消息</a><i class="icon-angle-right"></i></li>
							<li><a href="selUserNoticeRead">用户动态消息读取记录</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改用户动态消息读取记录</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<select class="m-wrap small" id="user_role_type">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="read_time" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">读取来源：</label>
													<div class="controls">
														<input id="from_type" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selUserNoticeRead">返回</a>
	...
	function infoset(){
		...
		var id=noticeread.id;
		
		var	user_id=noticeread.user_id;
		var	user_role_type=noticeread.user_role_type;
		var	user_role_value=noticeread.user_role_value;
		var	read_time=noticeread.read_time;
		var	from_type=noticeread.from_type;
