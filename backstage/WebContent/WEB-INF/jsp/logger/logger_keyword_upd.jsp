...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					 <div class="span12">
            <h3 class="page-title">
                110系统的敏感字库  <!-- <small>正常账户列表</small> -->
            </h3>
            <ul class="breadcrumb">
              <li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
              <li><a href="#">敏感库配置</a><i class="icon-angle-right"></i></li>
              <li><a href="selKeyWords">110系统的敏感字库</a></li>
            </ul>
          </div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改110系统的敏感字库</span>
								</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">关键字来源：</label>
													<div class="controls">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selKeyWords">返回</a>
	...
	function infoset(){
		...
		var keywords=${keywordsinfo };
		console.log(keywords);
		var keywordsinfo=keywords[0];
		var id =keywordsinfo.id;
		var name =keywordsinfo.name;
		var from =keywordsinfo.from;
		var status =keywordsinfo.status;
		var add_time =keywordsinfo.add_time;
