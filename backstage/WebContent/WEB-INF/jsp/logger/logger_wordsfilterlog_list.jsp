					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insWordsFilterLog"><i class="icon-pencil"></i>新增关键字屏蔽记录信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										...
										<li>是否处理：
											<select type="text" id="is_filter" style="width:102px">
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					default:
					 ...
					 "<td>"+is_filterstr+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readWordsFilterLog?id="+id+"'> 修改</a><a href='delWordsFilterLog?id="+id+"'> 删除</a>"+"</td>"+
					 "</tr>";
