					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserNoticeRead"><i class="icon-pencil"></i>新增用户动态消息读取记录</a>
								</div>
							</div>
							...
							<div class="row_fluid ">
								<ul>
					                <li>对象ID：<input type="text" id="userid" class="small m-wrap" ></li>
					                <li>对象类型：</li>
					                <li><select class="m-wrap small" id="role_type">
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					case "Agent":
					 ...
					 "<td>"+read_time+"</td>"+
					 "<td>"+from_type+"</td>"+
					 "<td>"+"<a href='readUserNoticeRead?id="+id+"'>修改</a><br><a href='delUserNoticeRead?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
