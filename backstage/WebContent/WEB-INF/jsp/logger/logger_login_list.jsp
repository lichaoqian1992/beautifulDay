					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title" style="height:20px">
								...
								<!-- <div class="actions">
									<a  class="btn blue"><i class="icon-pencil"></i>新增用户登录日志</a>
								</div> -->
							</div>
							...
							<ul>
								...
								<li>备注说明：<input type="text" id="remark" class="small m-wrap" ></li>
			...
			success : function(freshdata) {
				...
				if(freshdata.status ==0){
					...
					$.each(data,function(i,item){
						...
						switch (login_from){
						case "App_IOS":
							login_from_name="IOS客户端";
							break;
						case "App_Android":
							login_from_name="安卓客户端"
							break;
						...
						default :
						 ...
						 "<td>"+login_time+"</td>"+
						 "<td>"+login_ip+"</td>"+
						 "<td>"+login_from_name+"</td>"+
						 "<td>"+"<a href='readLoginLog?id="+id+"'>修改</a>"+"</td>"+
						 "</tr>";
