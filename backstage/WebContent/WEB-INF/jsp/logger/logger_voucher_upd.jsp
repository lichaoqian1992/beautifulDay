...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改代金券变动日志</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var voucherloginfo=${voucherloginfo };
		
		var id=voucherloginfo.id;
		var user_id=voucherloginfo.user_id;
		var user_role_type=voucherloginfo.user_role_type;
		var user_role_value=voucherloginfo.user_role_value;
		var account_id=voucherloginfo.account_id;
		var value=voucherloginfo.value;
		var order_no=voucherloginfo.order_no;
		var type=voucherloginfo.type;
		var remark=voucherloginfo.remark;
		var add_time=voucherloginfo.add_time;
		var old_value=voucherloginfo.old_value;
		var new_value=voucherloginfo.new_value;
		var user_ip=voucherloginfo.user_ip;
		var transaction_no=voucherloginfo.transaction_no;
