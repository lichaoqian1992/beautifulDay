        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <ul class="breadcrumb">
              ...
              <li><a href="#">用户角色管理员审核记录操作日志</a></li>
            </ul>
          </div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insAuditLog"><i class="icon-pencil"></i>新增用户角色管理员审核记录操作日志</a>
                </div>
              </div>
    ...
    success : function(freshdata) {
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          var audit_list_id=item.audit_list_id;
          var type =item.type;
          ...
          var login_ip =item.login_ip;
           ...
           "<td>"+add_time+"</td>"+
           "<td>"+login_ip+"</td>"+
           "<td>"+"<a href='readAuditLog?id="+id+"'>修改</a><a href='delAuditLog?id="+id+"'> 删除</a>"+"</td>"+
           "</tr>";
