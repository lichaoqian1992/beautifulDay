...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="insShopZisong">商家自送</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改商家自送</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<textarea id="area" type="text" 	class="m-wrap medium" ></textarea><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">市：</label>
													<div class="controls">
														<input id="city" type="text" 	class="m-wrap large" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selShopZisong">返回</a>
	...
	function infoset(){
		...
		var	shop_id=zisong.shop_id;
		var	type=zisong.type;
		var	area=zisong.area;
		var	city=zisong.city;
		var	is_free=zisong.is_free;
		var	free_price=zisong.free_price;
		var	add_time=zisong.add_time;
		var	update_time=zisong.update_time;
		var	remark=zisong.remark;
