					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insBusinessSms"><i class="icon-pencil"></i>新增短信信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	sms_number=item.sms_number;
					var	cust_money=item.cust_money;
					var	sms_count_number=item.sms_count_number;
					...
					switch(is_del){
					 ...
					 "<td>"+sms_number+"</td>"+
					 "<td>"+cust_money+"</td>"+
					 "<td>"+sms_count_number+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+One+"</td>"+


					 "<td>"+"<a href='readBusinessSms?id="+id+"'>修改</a><br><a href='delBusinessSms?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
