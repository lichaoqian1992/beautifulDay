...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">用户全国地区筛选</span>
                </div>
              </div>
                    ...
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="#" class="form-horizontal">
                        ...
                        <div class="form-actions">
                          ...
                          <a type="button" class="btn"  href="selApoScreen">返回</a>
  ...
  function infoset(){
    ...
    var aposcreeninfo=${aposcreeninfo };
    var id=aposcreeninfo.id;
    var code=aposcreeninfo.code;
    var name=aposcreeninfo.name;
    var type=aposcreeninfo.type;
    var sort_id=aposcreeninfo.sort_id;
