...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insApoVillage"><i class="icon-pencil"></i>新增用户</a>
                </div>
              </div>
  ...
  <script src="media/js/jquery.uniform.min.js" type="text/javascript" ></script>
   <script src="media/js/jquery.jqpagination.js" type="text/javascript" ></script>
