          ...
          <div class="span12">
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insSpec"><i class="icon-pencil"></i>添加内容派生的商品规格信息</a>
                </div>
              </div>
              <div class="portlet-body">
                <div class="row_fluid ">
                	<div class="span2"><span style="line-height: 30px;">规格名称：</span><input type="text" id="ggname" class="small m-wrap" ></div>
					<div class="span2">
	...
	<script>
		...
		$("#querySpec").click("on",function(){
			...
			$.ajax({
				...
				dataType : "json",
				contentType : "application/json; charset=utf-8",
				data : {category_id:$("#categoryid").val(),name:$("#ggname").val()},
				success : function(data) {
					console.log(data);
