          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insQrCode"><i class="icon-pencil"></i>新增二维码信息</a>
                </div>
              </div>
              ...
              <div class="row_fluid ">
                ...
                <li>名称：<input type="text" id="name" class="small m-wrap" ></li>
                <li>类别：
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          default:
           ...
           "<td>"+"<a href='readQrCode?id="+id+"'>修改</a><br><a href='delQrCode?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
