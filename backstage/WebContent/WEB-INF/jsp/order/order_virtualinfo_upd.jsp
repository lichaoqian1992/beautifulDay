...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selOrderVirtualinfo">订单详细虚拟券信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改订单详细虚拟券信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var ordervirtualinfo=${ordervirtualinfo };
		
		var id=ordervirtualinfo.id;
		var article_id=ordervirtualinfo.article_id;
		var order_id=ordervirtualinfo.order_id;
		var goods_id=ordervirtualinfo.goods_id;
		var ticket_no=ordervirtualinfo.ticket_no;
		var add_time=ordervirtualinfo.add_time;
		var expired_time=ordervirtualinfo.expired_time;
		var state=ordervirtualinfo.state;
		var update_time=ordervirtualinfo.update_time;
		var sms_send_state=ordervirtualinfo.sms_send_state;
		var sms_send_time=ordervirtualinfo.sms_send_time;
		var back_order_id=ordervirtualinfo.back_order_id;
