					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insAgentInfo"><i class="icon-pencil"></i>新增用户代理商信息</a>
								</div>
							</div>
							...
							<div class="row_fluid ">
								...
								<li class="">
									状态：<select id="state" class="small m-wrap" >
								...
								<li class=""><a  class="btn btn-primary search_sub" onclick="queryinfo(1)">搜索</a></li>
								</ul>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					rowhtml ="<tr>"+
							 ...
							 "<td>"+end_time+"</td>"+
							 "<td>"+statestr+"</td>"+
							 "<td>"+"<a href='readAgentInfo?id="+id+"'>修改</a>&nbsp<a href='delAgentInfo?id="+id+"'>删除</a>"+"</td>"+
							 "</tr>";
					tablehtml+=rowhtml;
