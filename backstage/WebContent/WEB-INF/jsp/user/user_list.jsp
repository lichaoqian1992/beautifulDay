					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<ul>
								...
								<li>账户状态:
									<select style="width:102px;" id="stu">
			...
			if(freshdata.status ==0){
				...
				/* 	var pay_password=item.pay_password; */
					...
					/*  "<td>"+avatar+"</td>"+ */
					 ...
					 "<td>"+reg_ip+"</td>"+
					 "<td>"+is_delStr+"</td>"+
					 "<td><a href='downLine?user_id="+id+"'>下线</a></td>"+
					 "<td style='width:80px'>"+"<a href='readUser?id="+id+"'>修改</a>&nbsp<a href='delUser?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
