...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">用户角色信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var	role_type=userrole.role_type;
		var	role_value=userrole.role_value;
		var	operator_type_id=userrole.operator_type_id;
		var	add_time=userrole.add_time;
		var	expired_time=userrole.expired_time;
		var	state=userrole.state;
		var	update_time=userrole.update_time;
		var	remark=userrole.remark;
		var	is_online=userrole.is_online;

	 	$("#hiddenid").val(id);
	 	$("#user_id").val(user_id);
	 	$("#role_type").val(role_type);
	 	$("#role_value").val(role_value);
	 	$("#operator_type_id").val(operator_type_id);
