					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserRoleGroup"><i class="icon-pencil"></i>新增用户角色分组信息</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					switch (is_del){
					 ...
					 "<td>"+"<a href='readUserRoleGroup?id="+id+"'>修改</a><br><a href='delUserRoleGroup?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
