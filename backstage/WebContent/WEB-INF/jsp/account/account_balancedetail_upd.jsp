...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
								账户结算子表	<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">账户结算信息</a><i class="icon-angle-right"></i></li>
							<li><a href="selUserBalanceDetail">账户结算子表</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改账户结算子表</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">主表中的记录标识：</label>
													<div class="controls">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="balance_point" type="text" 	class="m-wrap large" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">记录备注：</label>
													<div class="controls">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selUserBalanceDetail">返回</a>
	...
	function infoset(){
		...
		var id=balancedetail.id;
		
		var	balance_hash=balancedetail.balance_hash;
		var	balance_amount=balancedetail.balance_amount;
		var	balance_voucher=balancedetail.balance_voucher;
		var	balance_point=balancedetail.balance_point;
		var	remark=balancedetail.remark;
		var	add_time=balancedetail.add_time;
		var	is_del=balancedetail.is_del;
