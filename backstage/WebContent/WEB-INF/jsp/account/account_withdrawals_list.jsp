				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="row_fluid">
								<ul>
									<li>提现用户ID：<input type="text" id="useridstr" class="small m-wrap" ></li>
									<li>提现订单号：<input  type="text" id="ordernostr" class="medium m-wrap" ></li>
									<li>状态：<select id="statusstr" class="small m-wrap" style="width:100px !important" >
...
function queryinfo(index){
	...
	if($("#ordernostr").val()!=""){
		ajaxdatas+="&withdrawals_no="+$("#ordernostr").val();
	}
