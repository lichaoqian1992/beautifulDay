					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserBalanceDetail"><i class="icon-pencil"></i>新增账户结算子表</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					switch (is_del){
					 ...
					 "<td>"+add_time+"</td>"+
					 "<td>"+is_del+"</td>"+
					 "<td>"+"<a href='readUserBalanceDetail?id="+id+"'>修改</a><br><a href='delUserBalanceDetail?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
