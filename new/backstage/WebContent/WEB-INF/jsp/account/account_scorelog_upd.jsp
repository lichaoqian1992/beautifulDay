...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改商家信誉日志</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var	shop_id=balancedetail.shop_id;
		var	ebusiness_type=balancedetail.ebusiness_type;
		var	param_value=balancedetail.param_value;
		var	createtime=balancedetail.createtime;
		var	remark=balancedetail.remark;
		var	object_number=balancedetail.object_number;
		var	erule_type=balancedetail.erule_type;
	 	...
	 	$("#remark").val(remark);
	 	$("#object_number").val(object_number);
	 	$("#erule_type").val(erule_type);
