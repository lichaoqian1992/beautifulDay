...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selShopWuliumuban">商家物流模板</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改商家物流模板</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="expenses_companyId"></select>
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selShopWuliumuban">返回</a>
		    ...
		    $.ajax({
	            ...
	            success : function(data) {
	              ...
	              for(var i in dataList){
	                 $('#expenses_companyId').append('<option value='+dataList[i].id+'>'+dataList[i].title+'</option>');
	              } 
	              $('#expenses_companyId option[value="'+wu.expenses_companyId+'"]').attr('selected',true); 
	            }
	      	});
		});
	...
	function infoset(){
		...
		var	shop_id=wuliu.shop_id;
		var	name=wuliu.name;
		var	expenses_companyId=wuliu.expenses_companyId;
		var	is_del=wuliu.is_del;
		var	add_time=wuliu.add_time;
		var	update_time=wuliu.update_time;
		var	remark=wuliu.remark;


	 	$("#hiddenid").val(id);
	 	$("#shop_id").val(shop_id);
	 	$("#name").val(name);
	 	$("#expenses_companyId").val(expenses_companyId);
	 	$("#is_del").val(is_del);
	...
	$("#subbutton").on("click",function(){
		...
		data : {
			...
			shop_id:$("#shop_id").val(),
			name:$("#name").val(),
			expenses_companyId:$("#expenses_companyId").val(),
			is_del:$("#is_del").val(),
