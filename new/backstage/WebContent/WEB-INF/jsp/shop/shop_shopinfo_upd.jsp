        ...
        <div class="row-fluid">
         <div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selShopInfo">用户商家信息</a></li>
						</ul>
					</div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">修改用户商家信息</span>
                </div>
              </div>
...
/*   $.ajax({
      ...
      success : function(data) {
        ...
        $('#group_id option[value="'+shop.group_id+'"]').attr('selected',true); 
      }
});     */     
  ...
  function infoset(){
    ...
    var id =shopinfo.id;
    var group_id =shopinfo.group_id;
    var user_id =shopinfo.user_id;
    var name =shopinfo.name;
    var content =shopinfo.content;
    var pics =shopinfo.pics;
    var TAG =shopinfo.TAG;
    var pc_logo =shopinfo.pc_logo;
    var wap_logo =shopinfo.wap_logo;
    var mobile =shopinfo.mobile;
    var online_content =shopinfo.online_content;
    var address =shopinfo.address;
    var weburl =shopinfo.weburl;
    var area =shopinfo.area;
    var longitude =shopinfo.longitude;
    var latitude =shopinfo.latitude;
    var is_distribution =shopinfo.is_distribution;
    var distribution_area =shopinfo.distribution_area;
    var distribution_distance =shopinfo.distribution_distance;
    var is_express =shopinfo.is_express;
    var express_types =shopinfo.express_types;
    var is_local_transaction =shopinfo.is_local_transaction;
    var is_booking =shopinfo.is_booking;
    var is_plugins =shopinfo.is_plugins;
    var review_times =shopinfo.review_times;
    var review_score =shopinfo.review_score;
    var service_review_score =shopinfo.service_review_score;
    var pack_review_score =shopinfo.pack_review_score;
    var distribution_review_score =shopinfo.distribution_review_score;
    var damage_times =shopinfo.damage_times;
    var damage_money =shopinfo.damage_money;
    var damage_date =shopinfo.damage_date;
    var state =shopinfo.state;
    var remark =shopinfo.remark;
    var update_time =shopinfo.update_time;
    var add_time =shopinfo.add_time;
    var is_del =shopinfo.is_del;
    var main_business =shopinfo.main_business;
    var from_value =shopinfo.from_value;
    var is_sign_up =shopinfo.is_sign_up;
    var hot =shopinfo.hot;
    var yysj =shopinfo.yysj;
    var dpkg =shopinfo.dpkg;
    var percentage =shopinfo.percentage;
    var matter =shopinfo.matter;
    var is_balance =shopinfo.is_balance;
    ...
    $("#TAG").val(TAG);
    $("#pc_logo").val(pc_logo);
    $("#wap_logo").val(wap_logo);
    $("#mobile").val(mobile);
    $("#online_content").val(online_content);
    $("#address").val(address);
    $("#weburl").val(weburl);
    $("#area").val(area);
    ...
    $("#is_del").val(is_del);
    $("#main_business").val(main_business);
    $("#from_value").val(from_value);
    $("#is_sign_up").val(is_sign_up);
    $("#hot").val(hot);
    $("#yysj").val(yysj);
    $("#dpkg").val(dpkg);
