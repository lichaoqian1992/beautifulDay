...
<body class="page-header-fixed">
        ...
        <div class="row-fluid">
         <div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selOtherInfo">用户商家其他信息素材</a></li>
						</ul>
					</div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">修改用户商家其他信息素材</span>
                </div>
              </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="#" class="form-horizontal">
                        ...
                        <div class="control-group">
                          <label class="control-label">商家用户id：</label>
                          <div class="controls">
                        ...
                        <div class="control-group">
                          <label class="control-label">录入人员ID：</label>
                          <div class="controls">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="file_url" type="text"   class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">添加时间：</label>
                          <div class="controls">
                            <textarea id="add_time"   class="m-wrap small" ></textarea><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">标记删除：</label>
                          <div class="controls">
                              <select id="is_del">
                        ...
                        <div class="form-actions">
                          ...
                          <a type="button" class="btn" href="selOtherInfo">返回</a>
  ...
  function infoset(){
    ...
    var id=otherinfo.id;
    var	shop_id=otherinfo.shop_id;
    var	shop_user_id=otherinfo.shop_user_id;
    var	category_id=otherinfo.category_id;
    var	add_user_id=otherinfo.add_user_id;
    var	title=otherinfo.title;
    var	file_url=otherinfo.file_url;
    var	add_time=otherinfo.add_time;
    var	is_del=otherinfo.is_del;
