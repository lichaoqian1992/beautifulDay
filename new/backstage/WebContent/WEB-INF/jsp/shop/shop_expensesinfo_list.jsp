					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insShopExpensesInfo"><i class="icon-pencil"></i>新增商家配送退货信息</a>
								</div>
							</div>
							...
							<div class="row_fluid ">
								<ul>
					                ...
					                <li>商家姓名：<input type="text" id="name" class="small m-wrap" ></li>
					                <li>详细地址：<input type="text" id="address" class="small m-wrap" ></li>
					                <li>类型:
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					switch(type){
					 ...
					 "<td>"+"<a href='readShopExpensesInfo?id="+id+"'>修改</a><br><a href='delShopExpensesInfo?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
