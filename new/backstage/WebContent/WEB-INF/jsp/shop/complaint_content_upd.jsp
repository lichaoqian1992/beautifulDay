...
<body class="page-header-fixed">
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">修改投诉处理详细内容</span>
                </div>
              </div>
                ...
                <div class="tabbable portlet-tabs">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="updCompContent" class="form-horizontal" method="POST"
  ...
  function infoset(){
    ...
    var compcontent=${compcontent };
    var id=compcontent.id;
    var complaint_id=compcontent.complaint_id;
    var type=compcontent.type;
    var content=compcontent.content;
    var supplement_content=compcontent.supplement_content;
    var img=compcontent.img;
    var time=compcontent.time;
	
    var xx = "";
	for(var i=0;i<img.split(",").length;i++){
		xx += "<img class='aa' style='width:100px;' src='"+img.split(",")[i]+"'>&nbsp;&nbsp;&nbsp;&nbsp;";
	}
    ...
    $("#type").val(type);
    $("#content").val(content);
    $("#supplement_content").val(supplement_content);
    $("#pics").html(xx);
    $("#time").val(time);
    $("#imgUrl").val(img);
