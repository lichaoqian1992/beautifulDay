...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改商家品牌</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updShopBrand" class="form-horizontal" method="POST"
	...
	function infoset(){
		...
		var	shop_id=shopbrand.shop_id;
		var	name=shopbrand.name;
		var	register_no=shopbrand.register_no;
		var	brand_type=shopbrand.brand_type;
		var	logo=shopbrand.logo;
		var	ascription_person=shopbrand.ascription_person;
		var	authorize_pics=shopbrand.authorize_pics;
		var	authorize_time=shopbrand.authorize_time;
		var	sys_brandId=shopbrand.sys_brandId;
		var	apply_type=shopbrand.apply_type;
		var	state=shopbrand.state;
		var	is_del=shopbrand.is_del;
		var	add_time=shopbrand.add_time;
		var	update_time=shopbrand.update_time;
		var	remark=shopbrand.remark;
	 	...
	 	$("#logo").attr('src',logo);
	 	$("#ascription_person").val(ascription_person);
	 	$("#authorize_pics").attr('src',authorize_pics);
	 	$("#authorize_time").val(authorize_time);
	 	$("#sys_brandId").val(sys_brandId);
