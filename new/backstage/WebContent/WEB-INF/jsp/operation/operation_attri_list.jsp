						...
						<div class="portlet box grey">
							...
							<div class="portlet-body">
								<div class="span2" style="display: none;">
									用户ID：<input type="text" id="userid" class="small m-wrap">
								</div>
								<div class="row_fluid ">
									<div class="span2">
									...
									<ul>
										<li>属性值：<input type="text" id="content"
					...
					$.ajax({
						...
						success : function(data) {
							...
							$.each(attrilist, function(i, attriitem) {
								...
								var newRow = "<tr>" + "<td>" + no + "</td>"
										+ "<td>" + fname + "</td>" + "<td>"
										+ sname + "</td>" + "<td>" + tname
										+ "</td>" + "<td>" + values + "</td>"
										+ "<td>"
										+ "<a href='chgAttri?attri_id=" + id
