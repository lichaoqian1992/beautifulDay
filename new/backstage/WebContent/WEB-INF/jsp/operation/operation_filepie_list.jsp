...
$(document).ready(
			...
			function() {
				...
				onkey(1);
				setactive("192");
			 	var datalist = ${filepielist};
			 	console.info(datalist);
		  	var tablehtml='';
		    var rowhtml='';
        for(var i=0;i<datalist.length;i++){
	          rowhtml = '<tr>'+
	          '<td>'+datalist[i].file_type+'</td>'+
        ...
        $("#tableBody").html(tablehtml);
			  ...
			  for(var i=0;i<datalist.length;i++){
				  list.push({});
				  list[i].label=datalist[i].file_type;
