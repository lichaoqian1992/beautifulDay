          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增菜单信息</span>
                </div>
              </div>
                ...
                <div class="tabbable portlet-tabs">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="addMenu" class="form-horizontal" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="control-group">
                          <label class="control-label">图标：</label>
                           <div class="controls">
								...
								<a id="upAgain" onclick="uploadpicdiv()" style="margin-left:5%">上传</a>
                          </div>
                        </div>
                        <div class="control-group">
