          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增广告导航信息</span>
                </div>
              </div>
                ...
                <div class="tabbable portlet-tabs">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="addAdvertNavigation" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <input type="hidden" id="hiddenid"value="">
                        <div class="control-group">
                          <label class="control-label">站点编号：</label>
                          <div class="controls">
                            <input id="siteid" type="text" name="siteid" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                          	<input id="parentitle" type="text" autocomplete="off"   class="m-wrap medium" /><span class="help-inline " id="fatherName" style="color:red;display:none">请选择正确的父类名称</span>
                          </div>
                          <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="attvalue" type="text" name="att_value" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="contentvalue" type="text" name="content_value" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group" style="display:none">
                          <label class="control-label">内容更新时间：</label>
                          <div class="controls">
                            <input id="updatetime" type="text" name="update_time" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="pcsortid" type="text" name="pc_sort_id" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="classlayer" type="text" name="class_layer" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="countclasslayer" type="text" name="count_class_layer" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">显示类别：</label>
                          <div class="controls">
                            <input id="showtype" type="text" name="show_type" class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
        ...
        $.ajax({
            ...
            if(data.result.length == 0 || parTitle==""){
             ...
             for(var i=0;i<data.result.length;i++){
            	 txt += "<li onclick='clickimginfo(this)'>  <span>"+data.result[i].title+"("+data.result[i].type+")"+"</span> </li><input type='hidden' value='"+data.result[i].id+"'/>"
             }
             $("#flieinfo").append(txt);
            }
            })
