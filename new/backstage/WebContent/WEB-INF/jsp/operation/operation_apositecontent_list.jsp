          ...
          <div class="span12">
            ...
            <div class="portlet box grey">
              <div class="portlet-title">
                ...
                <div class="actions">
                  <a  class="btn blue" href="insApoSiteContent"><i class="icon-pencil"></i>新增全国地区站点内容</a>
                </div>
              </div>
              ...
              <div class="portlet-body">
            	<div class=row_fluid>
					<ul>
						<li>站点编号：<input type="text" id="site_id" class="small m-wrap" ></li>
					   	<li>内容类型：
							<select  id="content_type"	 style="width:102px">
    ...
    success : function(freshdata) {
      ...
      if(freshdata.status ==0){
        ...
        $.each(data,function(i,item){
          ...
          var navigation_id=item.navigation_id;
		  ...
		  switch (content_type) {
           ...
           "<td>"+update_time+"</td>"+
           "<td>"+remark+"</td>"+
           "<td>"+"<a href='readApoSiteContent?id="+id+"'>修改</a>&nbsp;<a href='delApoSiteContent?id="+id+"'>删除</a>"+"</td>"+
           "</tr>";
