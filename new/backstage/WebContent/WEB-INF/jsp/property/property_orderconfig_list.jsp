		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
										订单功能设置<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">功能设置</a><i class="icon-angle-right"></i></li>
							<li><a href="#">订单功能设置</a></li>
						</ul>
					</div>
				</div>
				...
				$.each(data,function(i,item){
					...
					case 1:
					 ...
					 var rowhtml ="<tr>"+
						...
						"<td>"+statusstr+"</td>"+
						"<td>"+"<a href=readOrderConfig?id="+id+">修改</a>&nbsp<a href=delOrderConfig?id="+id+">删除</a>"+"</td>"+
						"</tr>";
