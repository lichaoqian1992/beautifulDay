...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insDistribution"><i class="icon-pencil"></i>新增配送方式信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										<li>配送名称：<input type="text" id="title" class="small m-wrap" ></li>
										<li>配送编码：<input type="text" id="express_code" class="small m-wrap" ></li>
										<li>是否锁定：
	...
	if($("#express_code").val()!=""){
		ajaxdatas+="&express_code="+$("#express_code").val();
	}
	if($("#is_lock").val()!=""){
				...
				$.each(data,function(i,item){
					...
					case 1:
					 ...
					 var rowhtml ="<tr>"+
						...
						"<td>"+sort_id+"</td>"+
						"<td>"+is_lockstr+"</td>"+
						"<td>"+"<a href='readDistribution?id="+id+"'>修改</a>&nbsp<a href='delDistribution?id="+id+"'>删除</a>"+"</td>"+
						"</tr>";
