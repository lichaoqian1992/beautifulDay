...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
								分类所用业务模板		<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">模板配置</a><i class="icon-angle-right"></i></li>
							<li><a href="selMbYewu">分类所用业务模板</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改分类所用业务模板</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selMbYewu">返回</a>
	...
	function infoset(){
		...
		var	category_id=mbyewu.category_id;
		var	content=mbyewu.content;
		var	status=mbyewu.status;
		var	add_time=mbyewu.add_time;
		var	update_time=mbyewu.update_time;
		var	remark=mbyewu.remark;
