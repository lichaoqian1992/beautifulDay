...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selSmsTemplate">短信模板管理</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改短信模板</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<textarea id="content"  	class="m-wrap large" ></textarea>
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selSmsTemplate">返回</a>
	...
	function infoset(){
		...
		var id=smstemplate.id;
		var title=smstemplate.title;
		var call_index=smstemplate.call_index;
		var content=smstemplate.content;
		var is_sys=smstemplate.is_sys;
