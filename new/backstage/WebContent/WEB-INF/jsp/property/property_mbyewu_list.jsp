					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insMbYewu"><i class="icon-pencil"></i>新增分类所用业务模板</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
				    ...
				    var stateStr = "";
					 ...
					 "<td>"+update_time+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readMbYewu?id="+id+"'>修改</a><br><a href='delMbYewu?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
