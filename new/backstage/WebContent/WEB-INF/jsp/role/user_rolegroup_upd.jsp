...
<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
								用户角色分组信息		<!-- <small>正常账户列表</small> -->
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="toMain">主页</a><i class="icon-angle-right"></i></li>
							<li><a href="#">用户角色管理</a><i class="icon-angle-right"></i></li>
							<li><a href="selUserRoleGroup">用户角色分组信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改用户角色分组信息</span>
								</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													<label class="control-label">分组值：</label>
													<div class="controls">
														<input id="group_value" type="text" 	class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
													</div>
												</div>
												<div class="control-group">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selUserRoleGroup">返回</a>
	...
	function infoset(){
		...
		var	user_id=rolegroup.user_id;
		var	role_type=rolegroup.role_type;
		var	role_value=rolegroup.role_value;
		var	group_value=rolegroup.group_value;
		var	state=rolegroup.state;
		var	update_time=rolegroup.update_time;
		var	remark=rolegroup.remark;
		var	is_del=rolegroup.is_del;
