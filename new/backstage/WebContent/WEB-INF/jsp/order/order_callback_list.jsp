					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderCallback"><i class="icon-pencil"></i>新增订单回调通知明细</a>
								</div>
							</div>
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var status=item.status;
					 ...
					 "<td>"+add_time+"</td>"+
					 "<td>"+status+"</td>"+
					 "<td>"+"<a href='readOrderCallback?id="+id+"'>修改</a>&nbsp;<a href='delOrderCallback?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
