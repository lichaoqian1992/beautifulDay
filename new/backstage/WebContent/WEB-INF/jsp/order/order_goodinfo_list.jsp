...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderGoodInfo"><i class="icon-pencil"></i>新增订单详细商品类信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								<div class=row_fluid>
									<ul>
										收件人姓名：<input type="text" id="accept_name" class="small m-wrap" >
										发货状态:<select id="express_status"  style="width:102px;">
	...
	if(index==0||index==""){
		...
		if($("#accept_name").val()!=""){
			ajaxdatas+="&accept_name="+$("#accept_name").val();
		}
		if($("#express_status").val()!=""){
			ajaxdatas+="&express_status="+$("#express_status").val();
		}


	$.ajax({
		type : "GET",
		url : "queryOrderGoodInfo",
		dataType : "json",
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var express_id=item.express_id;
					var express_no=item.express_no;
					var express_status=item.express_status;
					var express_time=item.express_time;
					...
					var is_receipt=item.is_receipt;
					var is_deliver=item.is_deliver;
					
					is_receipt == 0 ? is_receipt = "未延迟" : is_receipt = "已延迟";
					is_deliver == 0 ? is_deliver = "未延迟" : is_deliver = "已延迟";
					var express_statusStr = "";
					switch (express_status) {
				    case 1:
				    	express_statusStr = "未发货";
				      break;
				    case 2:
				    	express_statusStr = "已发货";
				      break;
				    case 3:
				    	express_statusStr = "自提";
				      break;
				    case 4:
				    	express_statusStr = "待设置运费";
				      break;
				    default:
				    	express_statusStr = "";
				    }
					 ...
					 "<td>"+is_receipt+"</td>"+
					 "<td>"+is_deliver+"</td>"+
					 "<td>"+"<a href='readOrderGoodInfo?id="+id+"'>修改</a><a href='delOrderGoodInfo?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
