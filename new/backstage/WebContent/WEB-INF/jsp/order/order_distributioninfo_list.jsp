...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderDistributioninfo"><i class="icon-pencil"></i>新增订单详细配送类信息</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								...
								<div class=row_fluid>
									<ul>
										<li>联系电话：<input type="text" id="mobile" class="small m-wrap" ></li>
										<li>配送状态:<select id="send_status"  style="width:102px;">
	...
	if(index==0||index==""){
		...
		if($("#send_status").val()!=""){
			ajaxdatas+="&send_status="+$("#send_status").val();
		}

	
	$.ajax({
		type : "GET",
		url : "queryOrderDistributioninfo",
		dataType : "json",
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var hop_arrive_time=item.hop_arrive_time;
					var send_time=item.send_time;
					var send_user_name=item.send_user_name;
					var send_user_mobile=item.send_user_mobile;
					var real_arrive_time=item.real_arrive_time;
					var sms_send_state=item.sms_send_state;
					var sms_send_time=item.sms_send_time;
					var send_status=item.send_status;
				    ...
				    case 3:
					 ...
					 "<td>"+area+"</td>"+
					 "<td>"+address+"</td>"+
					 "<td>"+hop_arrive_time+"</td>"+
					 "<td>"+send_time+"</td>"+
					 "<td>"+send_user_name+"</td>"+
					 "<td>"+send_user_mobile+"</td>"+
					 "<td>"+real_arrive_time+"</td>"+
					 "<td>"+sms_send_state+"</td>"+
					 "<td>"+sms_send_time+"</td>"+
					 "<td>"+send_statusStr+"</td>"+
					 "<td>"+members+"</td>"+
					 "<td>"+longitude+"</td>"+
					 "<td>"+latitude+"</td>"+
					 "<td>"+"<a href='readOrderDistributioninfo?id="+id+"'>修改</a><a href='delOrderDistributioninfo?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
