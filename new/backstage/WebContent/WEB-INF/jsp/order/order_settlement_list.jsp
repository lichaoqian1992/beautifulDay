					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderSettlement"><i class="icon-pencil"></i>新增订单结算内容信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var settlement_money=item.settlement_money;
					var percentage_money=item.percentage_money;
					var real_money=item.real_money;
					...
					var rowhtml ="<tr>"+
					 ...
					 "<td>"+settlement_money+"</td>"+
					 "<td>"+percentage_money+"</td>"+
					 "<td>"+real_money+"</td>"+
					 "<td>"+add_time+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readOrderSettlement?id="+id+"'>修改</a><a href='delOrderSettlement?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
