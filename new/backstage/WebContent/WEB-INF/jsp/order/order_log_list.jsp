					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insOrderLog"><i class="icon-pencil"></i>新增订单操作日志</a>
								</div>
							</div>
							...
							<div class="portlet-body">
								...
								<div class="row_fluid ">
									<ul>
										...
										用户ID：<input type="text" id="uid" class="small m-wrap" >
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var uid=item.uid;
					var beginstate=item.beginstate;
					var endstate=item.endstate;
					var createtime=item.createtime;
					var developername=item.developername;
					var remark=item.remark;
							...
							var rowhtml = "<tr>" + 
									...
									"<td>" + developername + "</td>" +
									"<td>" + remark + "</td>" +
									"<td>" + "<a href='readOrderLog?id=" + id
									+ "'>修改</a>&nbsp;<a href='delOrderLog?id=" + id
									+ "'>删除</a>" + "</td>" + "</tr>";
