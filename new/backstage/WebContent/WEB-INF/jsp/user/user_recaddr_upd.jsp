...
<body class="page-header-fixed">
        ...
        <div class="row-fluid">
         <div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selRecAddr">用户收货地址信息</a></li>
						</ul>
					</div>
        </div>
          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">修改用户收货地址信息</span>
                </div>
              </div>
                    ...
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="#" class="form-horizontal">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="address" type="text"   class="m-wrap medium" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="post_code" type="text"  class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input id="sex" type="text"  class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label">门牌：</label>
                          <div class="controls">
                            <input id="doorplate" type="text"  class="m-wrap small" /><!--  <span class="help-inline">Some hint here</span> -->
                          </div>
                        </div>
                        ...
                        <div class="form-actions">
                          ...
                          <a type="button" class="btn" href="selRecAddr">返回</a>
  ...
  function infoset(){
    ...
    var id=rainfo.id;
    var user_id=rainfo.user_id;
    var user_role_type=rainfo.user_role_type;
    var user_role_value=rainfo.user_role_value;
    var accept_name=rainfo.accept_name;
    var area=rainfo.area;
    var address=rainfo.address;
    var mobile=rainfo.mobile;
    var telphone=rainfo.telphone;
    var email=rainfo.email;
    var post_code=rainfo.post_code;
    var is_default=rainfo.is_default;
    var add_time=rainfo.add_time;
    var is_del=rainfo.is_del;
    var longitude=rainfo.longitude;
    var latitude=rainfo.latitude;
    var is_distribution=rainfo.is_distribution;
    var sex=rainfo.sex;
    var doorplate=rainfo.doorplate;

    $("#hiddenid").val(id);
    $("#user_id").val(user_id);
    $("#user_role_type").val(user_role_type);
    $("#user_role_value").val(user_role_value);
    $("#accept_name").val(accept_name);
    $("#area").val(area);
    $("#address").val(address);
    $("#mobile").val(mobile);
