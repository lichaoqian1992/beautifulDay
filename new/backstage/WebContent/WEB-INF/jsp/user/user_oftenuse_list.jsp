					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insUserOftenUse"><i class="icon-pencil"></i>新增用户常用信息</a>
								</div>
							</div>
		...
		success : function(freshdata) {
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var	update_times=item.update_times;
					...
					switch(is_del){
					 ...
					 "<td>"+update_times+"</td>"+
					 "<td>"+One+"</td>"+
					 "<td>"+"<a href='readUserOftenUse?id="+id+"'>修改</a><br><a href='delUserOftenUse?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
