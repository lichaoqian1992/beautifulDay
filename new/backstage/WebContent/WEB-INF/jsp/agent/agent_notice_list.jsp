					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a  class="btn blue" href="insAgentNotice"><i class="icon-pencil"></i>发布代理公告</a>
								</div>
							</div>
							
							<div class="portlet-body">
							<div class="row_fluid "><ul>
...
/* 	ajaxdatas += "&user_role_type = Agent "; */
			...
			if(freshdata.status ==0){
				...
				$.each(data,function(i,item){
					...
					var remark=item.remark;
					 ...
					 "<td>"+update_time+"</td>"+
					 "<td>"+remark+"</td>"+
					 "<td>"+"<a href='readAgentNotice?id="+id+"'>修改</a>&nbsp;<a href='delAgentNotice?id="+id+"'>删除</a>"+"</td>"+
					 "</tr>";
