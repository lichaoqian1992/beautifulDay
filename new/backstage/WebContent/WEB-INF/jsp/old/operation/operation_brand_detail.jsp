  				...
  				<div class="ibox-content">
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-control"> <span id="brandname"></span> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">品牌LOGO：</label>
                            <div class="col-lg-6" id="brandlogo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <label><input type="radio" checked="checked"
											value="0" name="brand_type" disabled="disabled">国内</label> 
								<label><input type="radio" value="1" name="brand_type" disabled="disabled">国外</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <a class="btn btn-w-m btn-success" href="chgBrand?id=${brand_id } ">修改</a>
                                <a class="btn btn-w-m btn-default" type="submit" href="selBrand">返  回</a>
                            </div>
                        </div>
                    </form>
                </div>
