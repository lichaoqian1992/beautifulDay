					...
					<div class="ibox-content">
						<form class="form-horizontal" action="addBrand" method="POST" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="col-lg-6">
									<input type="text" placeholder="请输入品牌名称" name="name" class="form-control oper_name">
								</div>
								<div class="col-lg-2" id="oper_name"  style="line-height:34px;">
