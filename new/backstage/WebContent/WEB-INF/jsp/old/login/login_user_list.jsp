		...
		<div id="side-menu">
			<ul class="nav" >
				...
				<li class="active k11"><a><i class="fa fa fa-globe"></i> <span
					...
					<ul class="nav nav-second-level">
						<li class="active"><a href="*">登录用户列表</a></li>
			...
			function filltable(){
				...
				$.each(listdate,function(i,item){
					...
					var row ="<tr>"+
							 ...
							 "<td>"+role_name+"</td>"+
							 "<td>"+status+"</td>"+
							 "<td>"+"<a href='readLocalUser?user_id="+user_id+"'>详情</a>"+"</td>"+
							 "</tr>";
			...
			function queryusers(){
				...
				$.ajax({
					...
					success : function(freshdata) {
						var tablehtml="";
						$.each(freshdata,function(i,item){
							...
							var row ="<tr>"+
							 ...
							 "<td>"+role_name+"</td>"+
							 "<td>"+status+"</td>"+
							 "<td>"+"<a href='readLocalUser?id="+user_id+"'>详情</a>"+"</td>"+
							 "</tr>";
