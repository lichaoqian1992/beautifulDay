				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selActIndUser">首页推荐活动申请审核信息表</a></li>
						</ul>
					</div>
				</div>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="updActIndUser" class="form-horizontal" method="POST" enctype="multipart/form-data">
