...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="selChannelSpec">频道所用的规格信息</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改频道所用的规格信息</span>
								</div>
							</div>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="form-actions">
													...
													<a type="button" class="btn" href="selChannelSpec">返回</a>
	...
	function infoset(){
		...
		var channelspec=${channelspec };
		
		var id=channelspec.id;
		var channel_id  =channelspec.channel_id ;
		var spec_id      =channelspec.spec_id ;
