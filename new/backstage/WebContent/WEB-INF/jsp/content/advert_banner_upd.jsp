...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="hidden-480">修改广告位购买信息</span>
								</div>
							</div>
	...
	function infoset(){
		...
		var advertbanner=${advertbanner };
		
		var id=advertbanner.id;
		
		var	advert_id=advertbanner.advert_id;
		var	title=advertbanner.title;
		var	start_time=advertbanner.start_time;
		var	end_time=advertbanner.end_time;
		var	area=advertbanner.area;
		var	state=advertbanner.state;
		var	remark=advertbanner.remark;
		var	update_time=advertbanner.update_time;
		var	user_id=advertbanner.user_id;
		var	user_role_type=advertbanner.user_role_type;
		var	user_role_value=advertbanner.user_role_value;
		var	cust_money=advertbanner.cust_money;
		var	is_del=advertbanner.is_del;
