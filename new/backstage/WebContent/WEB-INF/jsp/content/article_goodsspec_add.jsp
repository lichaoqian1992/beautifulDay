          ...
          <div class="span12">
            ...
            <div class="portlet box blue tabbable">
              ...
              <div class="portlet-title">
                <div class="caption">
                  <span class="hidden-480">新增文章派生的商品类所选规则规格信息</span>
                </div>
              </div>
                ...
                <div class="tabbable portlet-tabs">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="portlet_tab1">
                      ...
                      <form action="addArticleGoodsSpec" class="form-horizontal" method="POST" enctype="multipart/form-data">
