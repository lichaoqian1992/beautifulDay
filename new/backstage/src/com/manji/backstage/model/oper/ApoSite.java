...
public class ApoSite {
	...
	public int getShop_min_number() {
		return shop_min_number;
	}
	public void setShop_min_number(int shop_min_number) {
		this.shop_min_number = shop_min_number;
	}
