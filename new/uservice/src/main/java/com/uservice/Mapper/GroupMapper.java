...
public interface GroupMapper {
     ...
     * @return
     */
    @Select("select juser.* from j_group_user,jgroup,juser where  j_group_user.user_id=juser.id and jgroup.id=j_group_user.group_id and j_group_user.group_id=(#{group_id})")
     ...
     * @return
     */
    @Select("select juser.* from j_group_user,jgroup,juser,j_user_role,jrole,j_role_menu,jmenu\n" +
            ...
            "and j_group_user.group_id=(#{0}) and jmenu.path=(#{1})")
