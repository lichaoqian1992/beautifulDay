...
public class InterfaceUtil {
    ...
    */
    ...
    public static  String GetAPI(String url, TreeMap<String,Object> map) throws IOException {
        String params="";
  ...
  //冻结账户接口处理
    public TreeMap<String, Object> getHttpTreeMap(String action,String remark,String role_type,Integer role_value,Integer user_id){
